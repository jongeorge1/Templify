namespace Endjin.Templify.MSBuild
{
	...
	public class CreatePackage : Task
	{
		...
		public CreatePackage(IPackageCreatorTasks packageCreatorTasks, ICommandOptionsMapper commandOptionsMapper)
		{
		...
		private void OnPackageCreatorTasksProgress(object sender, PackageProgressEventArgs e)
		{
			...
			this.Log.LogMessage(
				MessageImportance.Normal, ProgressMessageFormat, e.ProgressStage.GetDescription(), e.CurrentValue, e.MaxValue);
		}
	}
}